...
def plot_seperatlly(means, means_stde, number, set_name):
    ...
    # create and adjut figure
    treatment_figure = pyplot.figure(number, figsize=(25,15))
    treatment_figure.tight_layout()
    treatment_figure.subplots_adjust(hspace=0.3)



    # create all means axes and set parameters
    means_axes = treatment_figure.add_subplot(211)
    ...
    # create normalized axes and set parameters
    normalized_axes = treatment_figure.add_subplot(212)
    ...
    treatment_figure.text(0, -0.4, title_text, fontsize=22, transform=normalized_axes.transAxes)
